...
export function createSearchEngine(model) {
  ...
  if (model.engine === 'YV-C2-plain-v1' || model.engine === 'YV-description-full-v0-canonical-router' || model.engine === 'YV-A593-Gemma4-26B-sequence-expansion-v0') return createYvEngine(model);
